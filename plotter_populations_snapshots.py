        ...
        for m in ms:
            for version in versions:
                ...
                for solver in solvers:
                    num_snapshots = 0
                    while True:
                        filename = os.path.join(dirname, "populations_snapshots/dtlz" + str(dtlz) + "_" + str(n) + "_" + str(m) + "_" + solver + "_" + version + "_" + str(num_snapshots) + ".txt")
                ...
                for snapshot in range(num_snapshots):
                    ...
                    for i in range(len(solvers)):
                        ...
                        filename = os.path.join(dirname, "populations_snapshots/dtlz" + str(dtlz) + "_" + str(n) + "_" + str(m) + "_" + solvers[i] + "_" + version + "_" + str(snapshot) + ".txt")
                        ...
                        filename = os.path.join(dirname, "best_solutions_snapshots/dtlz" + str(dtlz) + "_" + str(n) + "_" + str(m) + "_" + solvers[i] + "_" + version + "_" + str(snapshot) + ".txt")
                        if os.path.exists(filename):
                            ys = []
                            for j in range(2):
                                ys.append([])
                    ...
                    fig.suptitle("dtlz" + str(dtlz) + "_" + str(n) + "_" + str(m), fontsize = "xx-large")
                    filename = os.path.join(dirname, "populations_snapshots/dtlz" + str(dtlz) + "_" + str(n) + "_" + str(m) + "_" + version + "_" + str(snapshot) + ".png")
