...
namespace dtlz {
/*****************************************************************************
 * The Solver abstract class represents a solver for the DTLZ test functions.
 *****************************************************************************/
class Solver {
    public:

    /************************************************
     * The id of the DTLZ test function been solved.
     ************************************************/
    unsigned dtlz;
     ...
     *
     * @param dtlz the id of the DTLZ test function been solved.
     ************************************************************/
    Solver(unsigned dtlz);
