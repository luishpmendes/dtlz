        ...
        for m in ms:
            for version in versions:
                ...
                for solver in solvers:
                    num_snapshots = 0
                    while True:
                        filename = os.path.join(dirname, "best_solutions_snapshots/dtlz" + str(dtlz) + "_" + str(n) + "_" + str(m) + "_" + solver + "_" + version + "_" + str(num_snapshots) +  ".txt")
                ...
                for snapshot in range(num_snapshots):
                    ...
                    filename = os.path.join(dirname, "best_solutions_snapshots/dtlz" + str(dtlz) + "_" + str(n) + "_" + str(m) + "_" + version + "_" + str(snapshot) + ".png")
